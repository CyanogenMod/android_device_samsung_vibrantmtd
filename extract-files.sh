...
adb pull /system/lib/libsamsungcamera.so ../../../vendor/$MANUFACTURER/$COMMON/proprietary/libcamera.so
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__COMMON__/proprietary/libcamera.so:system/lib/libsamsungcamera.so \\
